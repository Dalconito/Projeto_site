module.exports = function(app)
{
    ...
    app.get('/mostrar', function(req, res)
    {
        ...
        else if(q.query.categoria_titulo == "null")
        {
            function procura (element, index)
            {
                if(element.nome_titulo == q.query.procura_titulo)
                {
        ...
        else if(q.query.procura_titulo == "" && q.query.categoria_titulo != "null")
        {
            function procura (element, index)
            {
                if(element.categoria_titulo == q.query.categoria_titulo)
                {
                    index_arr[index] = index;
